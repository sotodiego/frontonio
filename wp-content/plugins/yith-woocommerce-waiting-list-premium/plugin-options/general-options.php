...
$general = array(
	...
	'general' => array(
		...
		'waiting-list-limited-stock-email' => array(
			'id'        => 'yith-wcwtl-limited-stock-email',
			'title'     => __( 'Send it only to some users, based on the stock value', 'yith-woocommerce-waiting-list' ),
			'desc'      => __( 'Send this email notification to a specific number of users based on the stock value entered. So, if you restock your product with 10 available items, only the first 10 contacts in the waiting list will be notified.', 'yith-woocommerce-waiting-list' ),
			'type'      => 'yith-field',
			'yith-type' => 'onoff',
			'default'   => 'no',
		),
