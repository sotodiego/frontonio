...
= 1.9.4 = Released on 04 February 2021

* New: support for WooCommerce 5.0
* Update: YITH plugin framework
* Update: language files
* Fix: in stock email not translated with WPML

= 1.9.3 = Released on 13 January 2021

* New: Support for WooCommerce 4.9
* Update: Plugin framework
* Update: Language files
* Fix: Waiting list data variations with no-latin charset

= 1.9.2 = Released on 04 December 2020

* New: Support for WooCommerce 4.8
* Update: Plugin framework
* Update: Language files

= 1.9.1 = Released on 04 November 2020
...
= 1.9.0 = Released on 13 October 2020

* New: Support for WooCommerce 4.6
* New: Use WordPress Actions Scheduler to handle email
* Update: Plugin framework
* Update: Language files
* Fix: Wrong redirect url on admin table actions
* Fix: Possible gateway timeout on email sending process

= 1.8.1 = Released on 17 September 2020

* New: Support for WooCommerce 4.5
* Dev: New placeholder "{product_sku}" available for waiting list admin email
* Update: Plugin framework
* Update: Language files

= 1.8.0 = Released on 14 August 2020

* New: Support for WooCommerce 4.4
* New: Support for WordPress 5.5
* New: Option to send the email only to some users based on the stock value
* Update: Plugin framework
* Update: Language files
* Dev: New filter 'yith_wcwtl_show_form'
* Dev: New filter 'yith_wcwl_product_thumb'
