...
if (!defined('K_TCPDF_EXTERNAL_CONFIG') OR !K_TCPDF_EXTERNAL_CONFIG) {
	...
	$tcpdf_config_files = array(dirname(__FILE__).'/config/tcpdf_config_cex.php', '/etc/php-tcpdf/tcpdf_config_cex.php', '/etc/tcpdf/tcpdf_config_cex.php', '/etc/tcpdf_config_cex.php');
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'TCPDF_CEX');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'TCPDF_CEX');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'TCPDF_CEX Example');
}
