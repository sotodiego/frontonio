...
--
-- Estructura de tabla para la tabla `ps_correos_oficial_requests`
--

DROP TABLE IF EXISTS `ps_correos_oficial_requests`;
CREATE TABLE IF NOT EXISTS `ps_correos_oficial_requests` (
