...
--
-- Estructura de tabla para la tabla `ps_correos_oficial_configuration`
--

DROP TABLE IF EXISTS `ps_correos_oficial_configuration`;
CREATE TABLE IF NOT EXISTS `ps_correos_oficial_configuration` (
...
--
-- Volcado de datos para la tabla `ps_correos_oficial_configuration`
--


INSERT INTO `ps_correos_oficial_configuration` (`name`, `value`) VALUES
