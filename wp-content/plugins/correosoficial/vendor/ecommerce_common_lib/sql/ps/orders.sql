...
--
-- Estructura de tabla para la tabla `ps_correos_oficial_orders`
--

DROP TABLE IF EXISTS `ps_correos_oficial_orders`;
CREATE TABLE IF NOT EXISTS `ps_correos_oficial_orders` (
...
DROP TABLE IF EXISTS `ps_correos_oficial_returns`;
CREATE TABLE IF NOT EXISTS `ps_correos_oficial_returns` (
  `id_order` int(11) NOT NULL,
  `id_sender` int(11) NOT NULL,
  `reference` varchar(9) CHARACTER SET utf8mb4 NOT NULL,
  `shipping_number` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `ps_correos_oficial_saved_orders`;
CREATE TABLE IF NOT EXISTS `ps_correos_oficial_saved_orders` (
...
DROP TABLE IF EXISTS `ps_correos_oficial_saved_returns`;
CREATE TABLE IF NOT EXISTS `ps_correos_oficial_saved_returns` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_order` int(11) NOT NULL,
  `shipping_number` varchar(255) NOT NULL,
  `exp_number` varchar(100) NOT NULL,
