...
-- Tiempo de generación: 24-06-2022 a las 07:11:34
...
--
-- Estructura de tabla para la tabla `wp_correos_oficial_pickuwp_returns`
--

DROP TABLE IF EXISTS `wp_correos_oficial_pickuwp_returns`;
CREATE TABLE IF NOT EXISTS `wp_correos_oficial_pickuwp_returns` (
