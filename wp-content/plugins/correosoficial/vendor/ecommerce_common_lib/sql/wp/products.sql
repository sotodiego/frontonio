...
--
-- Estructura de tabla para la tabla `wp_correos_oficial_products`
--

DROP TABLE IF EXISTS `wp_correos_oficial_products`;
CREATE TABLE IF NOT EXISTS `wp_correos_oficial_products` (
...
--
-- Volcado de datos para la tabla `wp_correos_oficial_products`
--

INSERT INTO `wp_correos_oficial_products` (`id`, `name`, `active`, `delay`, `company`, `url`, `codigoProducto`, `id_carrier`, `product_type`, `max_packages`) VALUES
