...
--
-- Estructura de tabla para la tabla `wp_correos_oficial_senders`
--

DROP TABLE IF EXISTS `wp_correos_oficial_senders`;
CREATE TABLE IF NOT EXISTS `wp_correos_oficial_senders` (
