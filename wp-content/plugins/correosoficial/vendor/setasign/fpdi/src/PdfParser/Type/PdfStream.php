...
use cosafpdi\Fpdi\PdfParser\Filter\Ascii85;
use cosafpdi\Fpdi\PdfParser\Filter\AsciiHex;
use cosafpdi\Fpdi\PdfParser\Filter\FilterException;
use cosafpdi\Fpdi\PdfParser\Filter\Flate;
use cosafpdi\Fpdi\PdfParser\Filter\Lzw;
...
use cosafpdi\FpdiPdfParser\PdfParser\Filter\Predictor;
                        ...
                        if ($predictor->value !== 1) {
                            if (!\class_exists(Predictor::class)) {
                                throw new PdfParserException(
                                    ...
                                    'commercial "FPDI PDF-Parser" add-on (see https://www.cosafpdi.com/fpdi-pdf-' .
                                    'parser).',
