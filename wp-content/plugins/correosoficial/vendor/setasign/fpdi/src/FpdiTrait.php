...
use cosafpdi\Fpdi\PdfParser\StreamReader;
use cosafpdi\Fpdi\PdfParser\Type\PdfArray;
use cosafpdi\Fpdi\PdfParser\Type\PdfBoolean;
use cosafpdi\Fpdi\PdfParser\Type\PdfDictionary;
use cosafpdi\Fpdi\PdfParser\Type\PdfHexString;
use cosafpdi\Fpdi\PdfParser\Type\PdfIndirectObject;
use cosafpdi\Fpdi\PdfParser\Type\PdfIndirectObjectReference;
...
use cosafpdi\Fpdi\PdfParser\Type\PdfString;
use cosafpdi\Fpdi\PdfParser\Type\PdfToken;
...
use /* This namespace/class is used by the commercial FPDI PDF-Parser add-on. */
    ...
    cosafpdi\FpdiPdfParser\PdfParser\PdfParser as FpdiPdfParser;
