                ...
                <tr class="plugin-update-tr">
                    <td colspan="<?php echo esc_attr( $wp_list_table->get_column_count() ) ?>"
                        ...
                        <div class="notice inline notice-warning notice-alt">
                            <p>
								<?php
								echo wp_kses_post( sprintf( wp_kses_post( 'New version of %1$s available. You can download or <a href="%2$s" class="thickbox open-plugin-details-modal" title="%3$s">view version %4$s</a>. Please make sure that you fill your auto-update key in <a href="%5$s">Setting page</a>.' ),// phpcs:ignore WordPress.WP.I18n.MissingTranslatorsComment
										esc_html($plugin_name), esc_url( $details_url ), esc_attr( $plugin_name ), esc_html($r->new_version), esc_url( $this->setting_page_url ) )
								);
