...
class Init {
	...
	public function class_init() {
		...
		Compatible::init();
		View_Product::init();
//		include_once VIWEC_DIR . 'class' . DIRECTORY_SEPARATOR . 'email-template-customizer.php';
	...
	public function save_update_key() {
		...
		if ( isset( $_POST['viwec_auto_update_key'] ) && $_POST['viwec_auto_update_key'] ) {// phpcs:ignore WordPress.Security.NonceVerification.Missing
			$key = sanitize_text_field( $_POST['viwec_auto_update_key'] );// phpcs:ignore WordPress.Security.NonceVerification.Missing
