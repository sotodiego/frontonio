jQuery(document).ready(function ($) {
    ...
    window.TextInput = $.extend({}, Input, {
        ...
        init: function (data) {
            ...
            textField.one('click', '.viwec-quick-shortcode', () => {
                ul.append(Object.keys(ViWec.shortcodes).map(item => `<li>${item}</li>`));
            });
            ...
            textField.on('click', 'li', function () {
                ...
                if (!cursorPos) cursorPos = currentText.length;
    ...
    window.TextEditor = $.extend({}, Input, {
        ...
        subInit: function (element) {
            ...
            wp.editor.initialize('viwec-text-editor', {
                tinymce: {
                    mode: 'exact',
                    selector: '#viwec-text-editor',
                    content_style: 'body {background:#eeeeee; font-family: helvetica, arial, sans-serif;} p{margin:0;}',
                    theme: 'modern',
                    height: 'auto',
                    menubar: false,
                    statusbar: false,
                    ...
                    setup: function (editor) {
                        ...
                        let scList = Object.keys(ViWec.shortcodes).map((item) => ({text: item, value: item}));
